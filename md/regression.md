<span id="stopping-rules"></span><span id="index-0"></span>

# Stopping rules and regression to the mean<a href="#stopping-rules-and-regression-to-the-mean" class="headerlink"
...
data from more patients. As we go along, we do a *t* test to compare the
...
![](_images/sample-size.png)

This plot shows the *p* value of the difference between groups as we
...
You’d expect that the *p* value dip shouldn’t happen, since there’s no
...
enough and test after every data point, we will eventually cross *any*
...
class="reference internal">53</a></sup></span>
...
<span id="index-1"></span><span id="id1"></span>

## Truth inflation<a href="#truth-inflation" class="headerlink"
title="Permalink to this headline">¶</a>
...
class="reference internal">33</a></sup></span>
...
class="reference internal">3</a></sup></span>
...
is not automatic evidence that its results are biased, but it *is* a
suggestive detail.

<span id="index-2"></span>

## Little extremes<a href="#little-extremes" class="headerlink"
title="Permalink to this headline">¶</a>
...
less, and in fact *increase* on average.
...
class="reference internal">59</a></sup></span>
...
class="reference internal">21</a></sup></span>
