...
# Pseudoreplication: choose your data wisely<a href="#pseudoreplication-choose-your-data-wisely" class="headerlink"
title="Permalink to this headline">¶</a>

Many studies strive to collect more data through replication: by
...
Let’s return to a medical example. I have two groups of 100 patients
...
per patient and 1,000 data points per group.

Brilliant! 1,000 data points is quite a lot, and I can fairly easily
...
But wait: we expect that taking a patient’s blood pressure ten times
...
because they tested hundreds of neurons from just two rats.

In statistical terms, pseudoreplication occurs when individual
...
1.  Average the dependent data points. For example, average all the
...
It’s important to consider each approach before analyzing your data, as
...
not to artificially inflate their sample sizes when they retest samples.
