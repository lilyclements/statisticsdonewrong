<span id="power"></span><span id="index-0"></span>

# Statistical power and underpowered statistics<a href="#statistical-power-and-underpowered-statistics"
...
Statisticians provide the answer in the form of “statistical power.” The
...
less likely. Let’s try a simple example.
...
incredibly boring coin-flipping games. How to prove it?

You can’t just flip the coin a hundred times and count the heads. Even
with a perfectly fair coin, you don’t always get fifty heads:

![](_images/binomial.png)

<span class="caption-text">This shows the likelihood of getting
different numbers of heads, if you flip a coin a hundred times.</span>
...
Let’s work out the math. Let’s say we look for a *p* value of 0.05 or
...
only a little unfair. I can’t tell.

So, what happens if I flip a coin ten times and apply these criteria?

![](_images/power-curve-10.png)

This is called a *power curve.* Along the horizontal axis, we have the
...
ten tosses, based on the *p* value of the result.

You can see that if the coin is rigged to give heads 60% of the time,
...
flip a fair coin 1,000 times and get more than 600 heads.

<span id="power-underpowered"></span>

## The power of being underpowered<a href="#the-power-of-being-underpowered" class="headerlink"
title="Permalink to this headline">¶</a>

After hearing all this, you might think calculations of statistical
...
concluding there’s a real effect.
...
Consider a trial testing two different treatments for the same
...
Obviously, you won’t have terribly much data to compare side effect
rates. If four people have serious side effects in one group, and three
in the other, you can’t tell if that’s the medication’s fault.

Unfortunately, many trials conclude with “There was no statistically
...
be much more dangerous than the other.

You might think this is only a problem when the medication only has a
...
data to detect a 50% difference in *primary outcome* between treatment
...
class="reference internal">16</a></sup></span>
...
class="reference internal">12</a></sup></span>
...
when you assume this means there is no *real* difference. There may be a
difference, but the study was too small to notice it.

Let’s consider an example we see every day.

<span id="rtor"></span><span id="index-2"></span>

## The wrong turn on red<a href="#the-wrong-turn-on-red" class="headerlink"
title="Permalink to this headline">¶</a>
...
Several studies were conducted to consider the safety impact of the
...
significant, and so the consultant concluded there was no safety impact.
...
underpowered studies cost lives.
