...
# Everybody makes mistakes<a href="#everybody-makes-mistakes" class="headerlink"
title="Permalink to this headline">¶</a>

Until now, I have presumed that scientists are capable of making
...
class="reference internal">26</a></sup></span>
...
data were all available, would anyone analyze it all to spot errors?
...
Nobody gets scientific glory by checking code for typos.

Another solution might be <span id="index-2"
...
world and found to hold water.

That’s not entirely true; scientists often take previous studies for
...
class="reference internal">49</a></sup></span>

This is worrisome. Does the trend hold true for less speculative kinds
...
we would like it to be, and the results are not always favorable.

<table id="reproducibility" class="docutils footnote" data-frame="void"
data-rules="none">
